...
class WebRequester: NSObject {
    ...
    func requestJSON(urlStr:String, parameter:String, token:String? = nil, callback:@escaping (_ result:NSDictionary?, _ error:Error?) -> Void) {
    ...
    // Below are other Methods as Mentioned with comments
    ...
    func multipartRequest(urlStr:String, parameter:[String:Any],token:String? = nil, image:UIImage?, fileKey:String, callback:@escaping (_ status:Status, _ data:NSDictionary?) -> Void) {
